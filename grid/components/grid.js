...
var _scrollWrapper = __webpack_require__(11);
...
var _scrollDummy = __webpack_require__(20);
            ...
            return _react2.default.createElement(
                ...
                columns.map(function (column, i) {
                    return _react2.default.createElement(
                        ...
                        _this5.props.isColumnsResizable && _this5.renderResizer()
                    );
                })
            );
        }
...
SpreadsheetGridScrollWrapper.propTypes = _grid.propTypes;
...
var SpreadsheetGrid = function (_React$PureComponent) {
    ...
    _createClass(SpreadsheetGrid, [{
        ...
        value: function onGlobalKeyDown(e) {
            ...
            var rowsCount = this.props.rows.length;
        ...
        value: function onCellClick(x, y, row, columnId, e) {
            if (!(0, _lodash2.default)(this.state.disabledCells, { x: x, y: y })) {
                if (!e.skipCellClick && !(0, _lodash8.default)(this.state.focusedCell, { x: x, y: y })) {
                    this.setState({
        ...
        value: function getCellClassName(column, row, x, y) {
            return 'SpreadsheetGrid__cell' + ((0, _lodash8.default)(this.state.activeCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_active' : '') + ((0, _lodash8.default)(this.state.focusedCell, { x: x, y: y }) ? ' SpreadsheetGrid__cell_focused' : '') + (this.props.disabledCellChecker && this.props.disabledCellChecker(row, column.id) ? ' SpreadsheetGrid__cell_disabled' : '') + (column.getCellClassName ? ' ' + column.getCellClassName(row) : '');
        }
    }, {
        ...
        value: function renderBody() {
            ...
            var rows = [].concat((0, _lodash6.default)(this.props.rows, this.props.first, this.props.last));
            var columns = this.props.columns;
            var body = void 0;
            ...
            if (rows.length) {
                body = rows.map(function (row) {
                    return _react2.default.createElement(_row2.default, {
                        x: (0, _lodash4.default)(_this3.props.rows, row),
...
var SpreadsheetRow = function (_React$Component) {
    ...
    _createClass(SpreadsheetRow, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
            ...
            return this.props.x !== nextProps.x || currentActiveCell && currentActiveCell.x === this.props.x || nextActiveCell && nextActiveCell.x === this.props.x || this.props.disabledCells !== nextProps.disabledCells || this.props.columnWidthValues !== nextProps.columnWidthValues;
        }
    }, {
        key: 'render',
        value: function render() {
                ...
                columns.map(function (column, y) {
                    ...
                    return _react2.default.createElement(
                        _cell2.default,
                        {
                            ...
                            isActive: (0, _lodash2.default)(activeCell, coords),
                            isFocused: (0, _lodash2.default)(focusedCell, coords),
...
var SpreadsheetCell = function (_React$Component) {
    _inherits(SpreadsheetCell, _React$Component);

    function SpreadsheetCell() {
        _classCallCheck(this, SpreadsheetCell);

        return _possibleConstructorReturn(this, (SpreadsheetCell.__proto__ || Object.getPrototypeOf(SpreadsheetCell)).apply(this, arguments));
    }

    _createClass(SpreadsheetCell, [{
        key: 'shouldComponentUpdate',
        value: function shouldComponentUpdate(nextProps) {
            return this.props.isActive !== nextProps.isActive || this.props.isFocused !== nextProps.isFocused || this.props.x !== nextProps.x || this.props.disabledCells !== nextProps.disabledCells || this.props.width !== nextProps.width;
        }
    }, {
        key: 'render',
        value: function render() {
